...
A full-stack software engineer building production-grade web applications — from UI to backend services to CI/CD pipelines.
...
✨ Thanks for stopping by — feel free to reach out if you want to build something together!
